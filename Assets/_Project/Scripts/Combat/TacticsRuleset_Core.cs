...
namespace TacticsGame.Core
{
    ...
    public static class TacticsRuleset_Core
    {
        /// <summary>
        /// Calculates the modifier for a specific ability score (e.g., 18 -> +4).
        /// TacticsRuleset rule: (Score - 10) / 2, rounded down.
        /// </summary>
        ...
        /// TacticsRuleset uses 5-10-5 for diagonals in movement, but reach uses simple "adjacency" logic
        ...
        /// <summary>
        /// TacticsRuleset 3D distance in tiles using the 2-step 5-10-5 diagonal rule.
        ...
        /// </summary>
        public static int GetTacticsRulesetDistance3D(Vector3Int a, Vector3Int b)
        {
            int dx = Mathf.Abs(a.x - b.x);
            int dy = Mathf.Abs(a.y - b.y);
            int dz = Mathf.Abs(a.z - b.z);
            int dHorizontal = RulesetMergeDiagonal(dx, dz);
            return RulesetMergeDiagonal(dHorizontal, dy);
        }

        /// <summary>
        /// Returns 3D TacticsRuleset distance in feet (tiles * 5).
        /// </summary>
        public static int GetTacticsRulesetDistance3DInFeet(Vector3Int a, Vector3Int b)
        {
            return GetTacticsRulesetDistance3D(a, b) * 5;
        }
        ...
        /// <summary>
        /// Merges two axis distances using TacticsRuleset's 5-10-5 alternating diagonal rule.
        /// Result = max(a,b) + floor(min(a,b) / 2).
        /// </summary>
        private static int RulesetMergeDiagonal(int a, int b)
        {
        ...
        /// TacticsRuleset rule: Untrained gives 0, others give Level + Constant.
        /// </summary>
        ...
        /// TacticsRuleset: Beat DC by 10 = Crit. Fail by 10 = Crit Fail. Nat 20/1 upgrades/downgrades one step.
        /// </summary>
        ...
        /// TacticsRuleset: DC = 10 + Level + Proficiency + Casting Ability Mod.
        ...
        )
        {
            ...
            if (conditions != null)
            {
                ...
                if (stupefied > 0)
                {
                    dc -= stupefied;
                    Debug.Log(
                        $"<color=orange>[TacticsRuleset CORE]</color> Spell DC reduced by {stupefied} from Stupefied."
                    );
                }
            }
        ...
        /// TacticsRuleset: Level + Proficiency + Casting Ability Mod - penalties.
        /// </summary>
